...
DB_DIR="/var/meterd"
DST_PATH="/var/www/html/img/raw-hour.svg"
...
set xtics 300
set format x "%H:%M"
`cat ${DB_DIR}/raw.hour.ranges`
plot "${DB_DIR}/raw.hour" using 1:2 title "consumption" with lines, \
	 "${DB_DIR}/raw.hour" using 1:3 title "production" with lines
EOF
